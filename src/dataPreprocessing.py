...
cfg = {    'data'     : { 'path'     : '/media/Data/ThioUr/raw/',
           ...
           'output'   : {
                          ...
                          'pulsefname'  : 'indexOpistest.h5',
                          'shotsfname'  : 'tracesOpistest.h5',  # use 'AUTO' for '<firstPulseId>-<lastPulseId.h5>'. Use this only when data.files is a list of subsequent shots.
                        },
